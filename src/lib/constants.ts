...
// Send (payment to supplier) categories
export const SEND_CATEGORIES = ['Procurement & Purchases', 'Services', 'Others']
export const SEND_SUB_CATEGORIES: Record<string, string[]> = {
  'Procurement & Purchases': ['Advance Vendor Payment', 'Credit Vendor Payment'],
  'Services':                ['Tax Filing', 'Legal & Compliance', 'Consulting', 'Logistics', 'Other Service'],
  'Others':                  ['Bank Charges', 'Refund', 'Miscellaneous'],
}

// Receive (payment from customer) categories
export const RECEIVE_CATEGORIES = ['Sales & Collections', 'Others']
export const RECEIVE_SUB_CATEGORIES: Record<string, string[]> = {
  ...
  'Others':              ['Refund Received', 'Miscellaneous'],
}
...
export const EXPENSE_SUB_CATEGORIES: Record<string, string[]> = {
  ...
  'Miscellaneous':   ['Miscellaneous', 'Handloan Received', 'Handloan Paid'],
}
